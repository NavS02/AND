...
async function checkRelations(item) {
  ...
  } else if (FotoIDs.length > 199) {
    alert("Schede trovate:>200");
  } else {
    alert("Nessuna scheda");
  }
}
...
async function getUserData() {
  ...
  if (rolResponse.data[0].name === "Administrator" || rolResponse.data[0].name === "Admin Fotografico") {
    isAdmin.value = true;
  }
