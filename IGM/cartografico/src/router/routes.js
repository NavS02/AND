...
import searchSer from "../archivio/components/Item/SearchSerie.vue";
...
import EditRoleArc from "../archivio/components/Item/EditRole.vue";
...
import stampaSinteticaCarta from "../archivio/components/Item/PrintItem/stampaSintetica.vue";
import stampaSinteticaSerie from "../archivio/components/Item/PrintItem/stampaSinteticaSerie.vue";

import CreateItem from "../archivio/components/Item/CreateItem.vue";

import ItemsMap from "../archivio/components/Item/ItemsMap.vue";
import AppDashboard from "../archivio/components/Item/AppDashboard.vue";
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        path: "/archivio/serie/search/:piano",
        name: "searchSer",
        component: searchSer,
        props: true,
        meta: { requiresAuth: true },
      ...
      {
        path: "/archivio/print/carta/:id",
        name: "stampaSinteticaCarta",
        component: stampaSinteticaCarta,
        props: true,
      },      {
        path: "/archivio/print/serie/:id",
        name: "stampaSinteticaSerie",
        component: stampaSinteticaSerie,
        props: true,
      },
      {
