<template>
  <main id="main" class="main">
    ...
    <div class="col-12">
      ...
      <div class="row">
        <div class="col-md-6">
          <label class="form-label" :for="`form-inventario_1930`"
            >Inventario 1930:</label
          >
          <input
            type="text"
            class="form-control"
            v-model="form.inventario_1930"
            :id="`form-inventario_1930`"
            aria-label="Small"
            aria-describedby="inputGroup-sizing-sm"
          />
        </div>
        <div class="col-md-6">
          <label class="form-label" :for="`form-inventario_1973`"
            >Inventario 1973:
          </label>
          <input
            type="text"
            class="form-control"
            v-model="form.inventario_1973"
            :id="`form-inventario_1973`"
            aria-label="Small"
            aria-describedby="inputGroup-sizing-sm"
          />
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <label class="form-label" :for="`form-inv_collocazione`"
            >Collocazione</label
          >

          <select
            class="form-select"
            aria-label="inv_collocazione"
            v-model="form.inv_collocazione"
            :id="'form-inv_collocazione'"
          >
            <option
              v-for="(col, index) in inv_collocazione"
              :key="index"
              :value="col"
            >
              {{ col }}
      ...
      <div class="row">
        <div class="col-md-6">
          <label class="form-label" :for="`form-provenienza`"
            >Provenienza:</label
          >
          <input
            type="text"
            class="form-control"
            v-model="form.provenienza"
            :id="`form-provenienza`"
            aria-label="Small"
            aria-describedby="inputGroup-sizing-sm"
          />
...
async function fetchData(predata) {
  ...
  let query = {
    ...
    filter: {},
    fields:
      "id,invn,inventario_1930,inventario_1973,IBS,autore,soggetto,quantita,icona,app,web,inv_oggetto",
  };
...
async function createWeb(itemSelected) {
  ...
  if (iconWeb.classList.contains("bi-tv") && item.inv_materia !== null) {
    ...
    iconWeb.className = "bi bi-tv-fill";
console.log(itemSelected.inv_oggetto)
    ...
    const response = await directus.items("inventario").updateOne(item.id, { web: response2.id });
  }
}
