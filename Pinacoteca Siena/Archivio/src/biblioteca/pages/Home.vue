...
export default {
  setup() {
    ...
    async function fetchDashboard() {
      const responseOp = await directus.items("biblioteca").readByQuery({
  ...
  aggregate: { count: "*" },
      ...
      const responseAut = await directus.items("bib_autore").readByQuery({
        aggregate: { count: "*" },
      });
