  ...
  setup(props, context) {
    ...
    watch(
      ...
      () => {
        ...
        const itemSettings2 = settings["biblioteca"];
        // // define the subset of fields you need to view in the table
    ...
    function onEditClicked(item) {
      router.push({
        name: "editItemFot",
        params: { id: item.id_foto, collection: "Foto" },
      });
    }
    ...
    function onInfoClicked(item) {
      currentItem.value = item.id_foto;
