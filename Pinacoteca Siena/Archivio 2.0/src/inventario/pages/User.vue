          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                ...
                <li class="nav-item" role="presentation" v-if="userRolePermissions.inventario.delete">
                  <button
                    class="nav-link"
                    data-bs-toggle="tab"
                ...
                <li
                  class="nav-item"
                  role="presentation"
                  v-if="me !== undefined && me.role === 'Administrator'"
                >
                  <button
                    class="nav-link"
                    data-bs-toggle="tab"
  ...
  setup(props, context) {
    ...
    watch(
      ...
      () => {
        ...
        const itemSettings2 = settings["inventario"];
        // // define the subset of fields you need to view in the table
    ...
    async function deleteOpera(item) {
      ...
      await store.collections.deleteOne("inventario", id);
      fetchDeletedItems();
    }
    return {
      authenticated,
