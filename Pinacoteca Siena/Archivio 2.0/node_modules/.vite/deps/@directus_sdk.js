...
var Auth = class extends IAuth {
  ...
  updateStorage(result) {
    ...
    this._storage.auth_expires_at = (/* @__PURE__ */ new Date()).getTime() + (expires !== null && expires !== void 0 ? expires : 0);
  }
  async refreshIfExpired() {
    ...
    if (this._storage.auth_expires_at < (/* @__PURE__ */ new Date()).getTime() + this.msRefreshBeforeExpires) {
      this.refresh();
    }
    try {
      await this._refreshPromise;
