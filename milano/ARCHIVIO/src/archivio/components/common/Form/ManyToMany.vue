<template>
  ...
  <b-drawer ref="createNewRef" style="z-index:9998 !important">
  ...
  <b-drawer ref="editItemRef" style="z-index:9998 !important">
    <template #header>Editare</template>
    <MyForm :fields="editFields" @change="editedData = $event" />
  </b-drawer>

  <b-drawer ref="addExistingRef" style="z-index:9998 !important">
...
const { related, foreign_key, preview, filter,sort } = field.value;
