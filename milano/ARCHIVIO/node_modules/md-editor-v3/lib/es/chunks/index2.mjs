...
const B = {
  ...
  setup(e, a) {
    const i = `${c}-dropdown-hidden`, t = E({
      ...
      if (!o || !l)
        return;
      const u = o.getBoundingClientRect(), f = o.offsetTop, b = o.offsetLeft, H = u.height, L = u.width, w = ((p = document.querySelector(e.relative)) == null ? void 0 : p.scrollLeft) || 0;
      t.overlayStyle = {
        ...t.overlayStyle,
        top: f + H + "px",
    ...
    return T(() => {
      r.value.addEventListener("mouseenter", s), r.value.addEventListener("mouseleave", g), n.value.addEventListener("mouseenter", m), n.value.addEventListener("mouseleave", g);
    }), O(() => {
      r.value.removeEventListener("mouseenter", s), r.value.removeEventListener("mouseleave", g), n.value.removeEventListener("mouseenter", m), n.value.removeEventListener("mouseleave", g);
    }), () => {
      const o = v({
        ctx: a
      }), l = v({
        props: e,
        ctx: a
      }, "overlay"), u = $(o instanceof Array ? o[0] : o, {
        ref: r
      }), f = d("div", {
